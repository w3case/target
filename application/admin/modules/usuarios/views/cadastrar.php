                ...
                <div class="widget-content">
                    ...
                    <div class="form-horizontal">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="nome" placeholder="Digite o nome do usuário" id="nome" class="span20" required>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="email" name="email" placeholder="Digite o e-mail do usuário" id="email" class="span20" required>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="cpf" placeholder="Digite o CPF do usuário" id="cpfMask" class="span20" required>
