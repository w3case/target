		  	...
		  	<tbody>
		    	<tr>
		      		...
		      		<td class="table-acoes">
		      			<a href="#" class="btn tooltip-link" data-toggle="tooltip" data-placement="top" title="Restaurar o registro">
		      				<i class="icon-arrow-up"></i>
		      			</a>

		      			<a href="#" class="btn tooltip-link" data-toggle="tooltip" data-placement="top" title="Excluir permanentimente do sitema">
